<template>
  <a-tooltip overlayClassName="bgc_tooltip" placement="rightTop" @visibleChange="visibleChange">
    ...
    <j-modal title="进度详情" :visible="visible" :width="1000" draggable :footer="null" :switchFullscreen="true" @update:visible="close">
